...
{% hint style="danger" %}
不要妨礙到其他玩家的土地。在設定之前看看有沒有玩家的建築，若有請不要包含到那邊喔！
{% endhint %}

{% hint style="info" %}
領地一格方塊 0.7 元，販售出去一塊 0.3 元
...
此指令會設定你的家點，不給定Home點名稱會將預設HOME點設為當前位置，否則會建立以Home點名稱為名的家點

此指令與領地指令最大的差別是此指令設定的HOME點與它的周遭不會被保護，因此不能設定玩家的權限

> /sethome \[Home點名稱]

### 前往自己的家

同理，如果當初建立Home點時沒有指定家點，也不必在這裡指定
...
可以前往自己擁有的領地或領地主設定該領地你的 `tp` 權限（或全域權限）為 `true` 的領地
...
> \[!IMPORTANT] 子領地的相關操作與主領地完全一致，例如移除、權限等
...
> \[!CAUTION] 在給予玩家領地前請三思而後行，本伺服器將不受理任何因人為失誤造成誤給、誤刪或誤全刪的人為錯誤，除非對方有詐騙或其他違反伺服器規則之嫌疑。
...
![chatgirls](https://whiter.lnstw.xyz/wp-content/uploads/2024/04/Default_As_the_sun_sets_behind_her_a_determined_anime_girl_sta_1.jpg)
